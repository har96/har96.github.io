...
export const EXPERIENCE: Job[] = [
      {
          ...
          employer: "US Army Engineering Research and Development Center (ERDC) - Vicksburg, MS",
          skills: ["Python", "C", "Bash", "Database Programming", "Game Engine Development", "Tradespace Analysis"],
          start_date: new Date("2012-06"),
          end_date: new Date("2018-07"),
...
President of the Association for Computing Machinery ERDC Chapter for one year.`
      },
      {
          ...
          employer: "Dassault Systémes (ENOVIA Brand) - Remote",
